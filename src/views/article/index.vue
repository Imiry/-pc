<template>
  <div class="acticle-container">
    ...
    <el-card class="box-card">
      ...
      <el-table  class="list-table" v-loading="loading" stripe height="500" :data="articles" size="mini"  style="width: 100%">
        <el-table-column prop="cover" label="封面" >
          <template slot-scope="scope">
            ...
            <!-- <img v-if="scope.row.cover.images[0]" class="article-cover" :src="scope.row.cover.images[0]" alt="" srcset="">
            <img v-else class="article-cover" src="./no-cover.gif" alt="" srcset=""> -->
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    //点击页码跳转到对应的数据
    onCurrentChange(page) {  //调用传过来page
